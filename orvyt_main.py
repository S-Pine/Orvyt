...
async def on_ready():
    ...
    for guild in client.guilds:
        cursor.execute(f'CREATE TABLE %s (MemberID INT PRIMARY KEY, Credits INT DEFAULT 0, Items VARCHAR(25)[] DEFAULT VARCHAR(25)[], Schematics integer[] DEFAULT array[0]::integer[])',(guild.id))
